...
const themeColors = {
  ...
  cyberpunk: 'bg-gradient-to-br from-blue-500/20 to-blue-600/20 border-blue-500/30',
  'dark-fantasy': 'bg-gradient-to-br from-[#2563EB]/20 to-red-600/20 border-[#2563EB]/30'
}

const statusColors = {
  active: 'bg-[#2563EB]/20 text-[#3B82F6] border-[#2563EB]/30',
...
export function CampaignList() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-[#1E40AF] to-slate-900">
      <div className="container mx-auto px-6 py-8">
        {/* Header */}
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl text-white mb-2">Your Campaigns</h1>
            <p className="text-[#60A5FA]">Choose your adventure or create a new one</p>
          </div>
          <Button 
            size="lg"
            className="bg-gradient-to-r from-[#2563EB] to-[#22C55E] hover:from-[#3B82F6] hover:to-[#4ADE80] text-white px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            return (
              ...
              >
                ...
                <CardContent className="space-y-4">
                  <p className="text-[#60A5FA] text-sm leading-relaxed line-clamp-3">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="border-[#2563EB]/30 text-[#60A5FA] hover:bg-[#2563EB]/20"
                    >
          ...
          <Card className="bg-black/40 backdrop-blur-sm border-dashed border-[#2563EB]/50 hover:border-[#22C55E]/70 hover:bg-black/50 transition-all duration-300 flex items-center justify-center min-h-[300px] cursor-pointer group">
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-[#2563EB]/20 rounded-full flex items-center justify-center group-hover:bg-[#22C55E]/30 transition-colors">
                <Plus className="w-8 h-8 text-[#3B82F6]" />
              </div>
              <h3 className="text-white text-xl mb-2">Start New Adventure</h3>
              <p className="text-[#60A5FA] text-sm">Create a custom campaign with AI assistance</p>
            </div>
          </Card>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
          <Button 
            variant="outline" 
            size="lg" 
            className="border-[#2563EB]/30 text-[#60A5FA] hover:bg-[#2563EB]/20 h-16"
          >
